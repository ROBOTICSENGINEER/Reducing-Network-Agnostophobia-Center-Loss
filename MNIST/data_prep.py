...
class cifar_prep:
    ...
    def __init__(self):
        cifar_data = pickle.load(open('../datasets/cifar-10-batches-py/data_batch_1', 'rb'), encoding='bytes')
        raw_images=cifar_data[b'data'].reshape(cifar_data[b'data'].shape[0],32,32,3, order='F')
        resized_images=[]
...
class hindi_letters:
    ...
    def __init__(self):
        root_path = '../datasets/Hindi_Letters/nhcd/'
...
class NOT_MNIST:    
    def __init__(self,invert_image=True):
        root_path = '../datasets/notMNIST_small/'
